...
class Robot : public frc::IterativeRobot {
 public:
  ...
  static  const int FRONT_LEFT_WHEEL = 2;  //Same values as Robot2018 Github
  static const int FRONT_RIGHT_WHEEL = 6;
  static const int BACK_LEFT_WHEEL = 3;
  ...
  static const int WINCH_PIN = 5; //fix these
  static const int INTAKE_PIN = 4;
